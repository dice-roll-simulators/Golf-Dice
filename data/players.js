...
const REAL_EXTRA = [
  ...
  // +300 more real Korn Ferry Tour graduates (Wikipedia "Category:Korn Ferry
  // Tour graduates") — Korn Ferry Tour dates only to 1990, so this stays a
  // safer, current-era-leaning pool than pulling from golf's full historical record.
  ...
  ["Matt Gogel","USA"],["Mathew Goggin","AUS"],["Fabián Gómez","USA"],["Jaime Gomez","USA"],["Andres Gonzales","USA"],
  ["Talor Gooch","USA"],["Jason Gore","USA"],["Steve Gotsche","USA"],["Jeff Gove","USA"],["Paul Gow","USA"],
  ["Estanislao Goya","ARG"],["Jimmy Green","USA"],["Nathan Green","USA"],["Cody Gribble","USA"],["Lanto Griffin","USA"],
  ["Mathias Grönberg","SWE"],["Scott Gump","USA"],["Luke Guthrie","USA"],["Scott Gutschewski","USA"],["Hunter Haas","USA"],
  ["Jerry Haas","USA"],["Chesson Hadley","USA"],["Adam Hadwin","USA"],["Brandon Hagy","USA"],["James Hahn","USA"],
  ["Paul Haley II","USA"],["Nick Hardy","USA"],["Brandon Harkins","USA"],["Jeff Hart","USA"],["David Hearn","USA"],
  ["Bob Heintz","USA"],["Brian Henninger","USA"],["J. J. Henry","USA"],["Mark Hensby","USA"],["Jim Herman","USA"],
  ["Kramer Hickok","USA"],["Justin Hicks","USA"],["Joe Highsmith","USA"],["Jason Hill","USA"],["Glen Hnatiuk","USA"],
  ["Bo Hoag","USA"],["Charley Hoffman","USA"],["Morgan Hoffmann","USA"],["P. H. Horgan III","USA"],["Ryan Howison","USA"],
  ["Bradley Hughes","USA"],["John Huh","USA"],["Ed Humenik","USA"],["Billy Hurley III","USA"],["Im Sung-jae","KOR"],
  ["Ryuji Imada","JPN"],["Trevor Immelman","USA"],["Tripp Isenhour","USA"],["Ryo Ishikawa","JPN"],["Hiroshi Iwata","JPN"],
  ["David Jackson","USA"],["Stephan Jäger","USA"],["Eric Johnson","USA"],["Kevin Johnson","USA"],["Richard Johnson","USA"],
  ["Zach Johnson","USA"],["Andrew Johnston","USA"],["Brendan Jones","USA"],["Kent Jones","USA"],["Matt Jones","USA"],
  ["Brian Kamm","USA"],["Craig Kanada","USA"],["Kang Sung-hoon","KOR"],["Smylie Kaufman","USA"],["Jerry Kelly","USA"],
  ["Troy Kelly","USA"],["Skip Kendall","USA"],["J. J. Killeen","USA"],["Chan Kim","USA"],["Kim Meen-whee","KOR"],
  ["Kim Si-woo","KOR"],["Kevin Kisner","USA"],["Patton Kizzire","USA"],["Jeff Klauk","USA"],["Colt Knost","USA"],
  ["Russell Knox","USA"],["Jason Kokrak","USA"],["Kelly Kraft","USA"],["Cliff Kresge","USA"],["Bronson La'Cassie","USA"],
  ["Doug LaBelle II","USA"],["Anirban Lahiri","IND"],["Martin Laird","USA"],["Rick Lamb","USA"],["Derek Lamely","USA"],
  ["Andrew Landry","USA"],["Franklin Langham","USA"],["Scott Langley","USA"],["Nate Lashley","USA"],["Danny Lee","KOR"],
  ["Lee Dong-hwan","KOR"],["Lee Kyoung-hoon","KOR"],["Lucas Lee","KOR"],["Ian Leggatt","USA"],["Tom Lehman","USA"],
  ["Marc Leishman","USA"],["Michael Letzig","USA"],["Spencer Levin","USA"],["J. L. Lewis","USA"],["Tom Lewis","USA"],
  ["Nicholas Lindheim","USA"],["David Lingmerth","SWE"],["Luke List","USA"],["Edward Loar","USA"],["Adam Long","USA"],
  ["Michael Long","NZL"],["Andrew Loupe","USA"],["Jamie Lovemark","USA"],["Justin Lower","USA"],["Steve Lowery","USA"],
  ["Curtis Luck","USA"],["Bill Lunde","USA"],["Jarrod Lyle","USA"],["Will MacKenzie","USA"],["Jeff Maggert","USA"],
  ["John Maginnes","USA"],["Hunter Mahan","USA"],["John Mallinger","USA"],["Peter Malnati","USA"],["Steve Marino","USA"],
  ["Ben Martin","USA"],["Casey Martin","USA"],["Doug Martin","USA"],["Dick Mast","USA"],["David Mathis","USA"],
  ["Troy Matteson","USA"],["Brandon Matthews","USA"],["Bob May","USA"],["Blaine McCallister","USA"],["Ryan McCormick","USA"],
  ["Tyler McCumber","USA"],["Jim McGovern","USA"],["David McKenzie","USA"],["Spike McRoy","USA"],["John Merrick","USA"],
  ["Troy Merritt","USA"],["Shaun Micheel","USA"],["Jon Mills","USA"],["Bryce Molder","USA"],["Taylor Montgomery","USA"],
  ["Patrick Moore","USA"],["Tommy Moore","USA"],["David Morland IV","USA"],["John Morse","USA"],["Trey Mullinax","USA"],
  ["Garth Mulroy","USA"],["Sebastián Muñoz","COL"],["Sean Murphy","USA"],["Grayson Murray","USA"],["Matthew NeSmith","USA"]
];

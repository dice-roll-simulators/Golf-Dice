...
const REAL_EXTRA = [
  ...
  // +285 more real Korn Ferry Tour / DP World Tour names (Wikipedia KFT-graduates
  // and European Tour categories), added to broaden the depth pool.
  ["Blake Adams","USA"],["Joe Affrunti","USA"],["Thomas Aiken","RSA"],["Tyler Aldridge","USA"],["Steven Alker","NZL"],
  ["Benjamín Alvarado","MEX"],["Chris Anderson","USA"],["Jerry Anderson","USA"],["Mark Anderson","USA"],["Kiradech Aphibarnrat","THA"],
  ["Stuart Appleby","AUS"],["Alex Aragon","USA"],["Ryan Armour","USA"],["Tommy Armour III","USA"],["Matt Atkins","USA"],
  ["Arjun Atwal","USA"],["Emlyn Aubrey","USA"],["Woody Austin","USA"],["Eric Axley","USA"],["Aaron Baddeley","USA"],
  ["Bae Sang-moon","KOR"],["Briny Baird","USA"],["Chris Baker","USA"],["Blayne Barber","USA"],["Rich Barcelo","USA"],
  ["Paul Barjon","USA"],["Erik Barnes","USA"],["Ricky Barnes","USA"],["Todd Barranger","USA"],["Doug Barron","USA"],
  ["Chris Baryla","USA"],["Ben Bates","USA"],["Pat Bates","USA"],["Notah Begay III","USA"],["Russell Beiersdorf","USA"],
  ["David Berganio Jr.","USA"],["Shane Bertsch","USA"],["Matt Bettencourt","USA"],["Henrik Bjørnstad","NOR"],["Kris Blanks","USA"],
  ["Ryan Blaum","USA"],["Jonas Blixt","USA"],["Jason Bohn","USA"],["Justin Bolli","USA"],["Eric Booker","USA"],
  ["Guy Boros","USA"],["Craig Bowden","USA"],["Steven Bowditch","AUS"],["Dominic Bozzelli","USA"],["Joseph Bramlett","USA"],
  ["David Branshaw","USA"],["Ryan Brehm","USA"],["D. J. Brigman","USA"],["Scott Brown","USA"],["Olin Browne","USA"],
  ["Wesley Bryan","USA"],["Andrew Buckle","USA"],["Hayden Buckley","USA"],["Jason Buha","USA"],["Bronson Burgoon","USA"],
  ["Bob Burns","USA"],["Jonathan Byrd","USA"],["Curt Byrum","USA"],["Chad Campbell","USA"],["Rafael Campos","PUR"],
  ["Sebastian Cappelen","USA"],["Miguel Ángel Carballo","ARG"],["Mark Carnevale","USA"],["Jim Carter","USA"],["Tom Carter","USA"],
  ["Roberto Castro","USA"],["Alex Čejka","USA"],["Greg Chalmers","AUS"],["Cameron Champ","USA"],["Kevin Chappell","USA"],
  ["Barry Cheesman","USA"],["Daniel Chopra","SWE"],["Gary Christian","USA"],["Michael Christie","USA"],["Stewart Cink","USA"],
  ["Tim Clark","USA"],["Paul Claxton","USA"],["Will Claxton","USA"],["Gavin Coles","USA"],["Chad Collins","USA"],
  ["Erik Compton","USA"],["Frank Conner","USA"],["Parker Coody","USA"],["Austin Cook","USA"],["Chris Couch","USA"],
  ["Kris Cox","USA"],["Jon Curran","USA"],["M. J. Daffue","USA"],["Joel Dahmen","USA"],["Joe Daley","USA"],
  ["Rick Dalpos","USA"],["Brian Davis","USA"],["Cameron Davis","USA"],["Marco Dawson","USA"],["Brendon de Jonge","USA"],
  ["Roberto Díaz","MEX"],["Chris DiMarco","USA"],["Trevor Dodds","USA"],["Dou Zecheng","CHN"],["Allen Doyle","USA"],
  ["Brett Drewitt","USA"],["James Driscoll","USA"],["Jason Dufner","USA"],["Ken Duke","USA"],["Doug Dunakey","USA"],
  ["Tyler Duncan","USA"],["Joe Durant","USA"],["David Duval","USA"],["R. W. Eaks","USA"],["Nico Echavarría","USA"],
  ["Joel Edwards","USA"],["Brad Elder","USA"],["Harrison Endycott","USA"],["Derek Ernst","USA"],["Julián Etulain","ARG"],
  ["Matt Every","USA"],["Brad Fabel","USA"],["Derek Fathauer","USA"],["Gonzalo Fernández-Castañó","USA"],["Todd Fischer","USA"],
  ["Nick Flanagan","USA"],["John Flannery","USA"],["Steve Flesch","USA"],["Martin Flores","USA"],["Kevin Foley","USA"],
  ["Óscar Fraustro","USA"],["Harrison Frazar","USA"],["Robin Freeman","USA"],["Brad Fritsch","USA"],["Ed Fryatt","USA"],
  ["Tommy Gainey","USA"],["Jeff Gallagher","USA"],["Scott Gardiner","USA"],["Brice Garnett","USA"],["Robert Garrigus","USA"],
  ["Bobby Gates","USA"],["Kelly Gibson","USA"],["Rhein Gibson","USA"],["Tom Gillis","USA"],["Michael Gligic","USA"],
  ["Matt Gogel","USA"],["Mathew Goggin","AUS"],["Fabián Gómez","USA"],["Jaime Gomez","USA"],["Andres Gonzales","USA"],  ["Warren Abery","ENG"],["Francisco Abreu","ENG"],["Cameron Adam","ENG"],["Paul Affleck","ENG"],["Felipe Aguilar","CHI"],
  ["Jaco Ahlers","RSA"],["Antti Ahokas","FIN"],["Thomas Aiken","RSA"],["Björn Åkesson","SWE"],["Steven Alker","NZL"],
  ["Stephen Allan","ENG"],["Michael Allen","ENG"],["Robert Allenby","AUS"],["Peter Alliss","ENG"],["Benjamín Alvarado","MEX"],
  ["Rubén Alvarez","MEX"],["Stephen Ames","ENG"],["Jerry Anderson","ENG"],["Fredrik Andersson Hed","SWE"],["Max Anglert","ENG"],
  ["Pep Anglès","ESP"],["Maverick Antcliff","ENG"],["Kiradech Aphibarnrat","THA"],["Phillip Archer","ENG"],["Connor Arendell","ENG"],
  ["Harry Ashby","ENG"],["Arjun Atwal","ENG"],["John Axelsen","ENG"],["Johan Axgren","ENG"],["Ángel Ayora","ENG"],
  ["Nick Bachem","ENG"],["Joakim Bäckström","ENG"],["Ross Bain","ENG"],["Hugh Baiocchi","ENG"],["Sam Bairstow","ENG"],
  ["Ian Baker-Finch","ENG"],["Chris Baker","ENG"],["Peter Baker","ENG"],["Vin Baker","ENG"],["Salvador Balbuena","MEX"],
  ["Manuel Ballesteros","ENG"],["Seve Ballesteros","ENG"],["Harry Bannerman","ENG"],["Benn Barham","ENG"],["Brian Barnes","ENG"],
  ["Valentín Barrios","ENG"],["De Wet Basson","RSA"],["Sion Bebb","ENG"],["Rich Beem","ENG"],["Notah Begay III","ENG"],
  ["Oliver Bekker","RSA"],["Brad Bell","ENG"],["Maurice Bembridge","ENG"],["Stephen Bennett","ENG"],["Warren Bennett","ENG"],
  ["Seve Benson","ENG"],["Clément Berardo","FRA"],["Jorge Berendt","ENG"],["Albin Bergström","ENG"],["Roberto Bernardini","ITA"],
  ["Nino Bertasio","ITA"],["Wil Besseling","ENG"],["Jon Bevan","ENG"],["Gaganjeet Bhullar","IND"],["John Bickerton","ENG"],
  ["Lucas Bjerregaard","ENG"],["Alexander Björk","SWE"],["Thomas Bjørn","DEN"],["Henrik Bjørnstad","NOR"],["John Bland","ENG"],
  ["Richard Bland","ENG"],["Ryan Blaum","ENG"],["Jonas Blixt","ENG"],["Adam Blommeé","ENG"],["Christofer Blomstrand","ENG"],
  ["Charlie Bolling","ENG"],["Liam Bond","ENG"],["Fred Boobyer","ENG"],["Diego Borrego","ENG"],["Knut Børsheim","DEN"],
  ["André Bossert","ENG"],["Desvonde Botes","RSA"],["Michiel Bothma","RSA"],["Steven Bottomley","ENG"],["Grégory Bourdy","FRA"],
  ["Ken Bousfield","ENG"],["Richard Boxall","ENG"],["Gary Boyd","ENG"],["Gordon J. Brand","ENG"],["Gordon Brand Jnr","ENG"],
  ["Sam Brazel","ENG"],["Merrick Bremner","RSA"],["Markus Brier","ENG"],["Christoffer Bring","ENG"],["Kalle Brink","ENG"],
  ["Tienie Britz","RSA"],["Paul Broadhurst","ENG"],["Kristoffer Broberg","SWE"],["Daniel Brooks","ENG"],["Jonathan Broomhead","ENG"],
  ["Per-Arne Brostedt","ENG"],["Dan Brown","ENG"],["Hamish Brown","ENG"],["Ken Brown","ENG"],["Mark Brown","ENG"],
  ["Steven Brown","ENG"],["Julien Brun","FRA"],["George Burns","ENG"],["Raymond Burns","ENG"],["Peter Butler","ENG"],
  ["Andrew Butterfield","ENG"],["Bob Byman","ENG"],["Rafa Cabrera-Bello","ESP"],["Ángel Cabrera","ARG"],["Stuart Cage","ENG"],
  ["Mike Cahill","ENG"],["Jonathan Caldwell","ENG"],["Giuseppe Calì","ITA"],["François Calmels","FRA"],["Michael Campbell","NZL"],
  ["Ariel Cañete","ARG"],["Alejandro Cañizares","ESP"],["José María Cañizares","ESP"],["Emanuele Canonica","ITA"],["Iván Cantero","ARG"],
  ["José Cantero","ARG"],["Miguel Ángel Carballo","ARG"],["Horacio Carbonetti","ARG"],["Luis Carbonetti","ARG"],["Eric Carlberg","ENG"],
  ["Johan Carlsson","ENG"],["Magnus A. Carlsson","ENG"],["José Manuel Carriles","ENG"],["Peter Carsbo","ENG"],["David Carter","ENG"],
  ["Paul Casey","ENG"],["John Catlin","ENG"],["Marc Cayeux","ENG"],["Alex Caygill","ENG"],["Alex Čejka","ENG"],
  ["Filippo Celli","ITA"],["Christian Cévaër","ENG"],["Greg Chalmers","AUS"],["Andrew Chandler","ENG"],["Roger Chapman","ENG"],
  ["Bob Charles","ENG"],["Shiv Chawrasia","IND"],["Ashley Chesters","ENG"],["Choi Jin-ho","KOR"],["Daniel Chopra","SWE"]
];

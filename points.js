...
// Dice — corrected Die 3 (sums to 50 now) — used only to seed the two demo
// results server-side; the client Dice tab has its own copy for rolling.
const DICE = [
  { id: 'd1', faces: { eagle: 1, birdie: 9, par: 30, bogey: 9, doubleBogey: 1 } },
  { id: 'd2', faces: { eagle: 1, birdie: 11, par: 30, bogey: 7, doubleBogey: 1 } },
  { id: 'd3', faces: { eagle: 1, birdie: 7, par: 30, bogey: 11, doubleBogey: 1 } },
  { id: 'd4', faces: { eagle: 1, birdie: 9, par: 70, bogey: 17, doubleBogey: 2, tripleBogey: 1 } },
];
